...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8142564775:AAF4gtargs0cVgj1KjWh4fl7pyMr6WK93PU")
APP_ID = int(os.environ.get("APP_ID", "22577441")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "d0df7c1ba9f5f6e2dd93abc16f3dead9") #Your API Hash from my.telegram.org
#--------------------------------------------
...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://a4darkcool:Arun@3435@cluster0.uhm6ycn.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "A4DARKCOOL")
#--------------------------------------------
